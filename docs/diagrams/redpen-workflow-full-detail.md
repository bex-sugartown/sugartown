...
| MERGE TO MAIN, "branch ≠ shipped" | CLAUDE.md §"Done vs Shipped" (renamed from §Issue Done = code on main, 2026-08-19, SUG-100 S2) — explicit verification command given in that section, read directly | convention |
| SHIP DOC, MINI-RELEASE, ISSUE DONE | CLAUDE.md's close-out sequence steps 4/7/9, read directly. **Label corrected 2026-08-19:** was "LINEAR DONE", which violated CLAUDE.md's own portability rule (write "issue", not "Linear issue") | convention |
