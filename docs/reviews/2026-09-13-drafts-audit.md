...
**Gates honored:** read-only. No Sanity writes, no file moves, nothing in `docs/drafts/` deleted or touched.
...
- **Disposition:** file an issue, create a Sanity draft (none needed here — issues cover that step), archive locally (Bex removes by hand — no session deletes), or flag (needs a decision this audit can't make).
...
| `article-site-built-itself.md` | article | **published**, `5b0046ad…`, slug `site-that-built-itself` — title matches verbatim | 2026-05-04 | Archive locally — already shipped |
...
| `homepage-draft-copy.md` | page copy | n/a (page copy, not a document type this query covers) — but the live Home page's hero heading (`"I build the systems behind the content."`) matches this draft's Option A verbatim | 2026-04-15 | Archive locally — already shipped |
| `services-copy-proposal.md` | page copy | n/a — Services page last updated 2026-08-08, three months after this proposal (2026-05-04); the proposal itself says most copy was "already there" | 2026-05-04 | Archive locally — very likely already actioned; skim the live page once before deleting |
...
| `node-the-great-disconnection.md` | node | **published**, `84d31e26…`, slug `the-great-disconnection`, status `validated` | 2026-04-05 | Archive locally — already shipped |
| `gem-three-white-screens.md` | node | **published**, `node-we-fixed-the-same-white-screen`, status `deprecated` | 2026-02-20 | Archive locally — already shipped (and since deprecated) |
...
| `table-ux-content-split-mockup.md` | spec / content-split mockup | **both halves already published** — node `sanity-custom-table-input` ("...47 Clicks of Pure Suffering") and article `sanity-table-authoring-ux` ("I Built a Spreadsheet Inside My CMS...") both exist, titles matching this mockup's two pieces verbatim | 2026-03-31 | Archive locally — already shipped, in full |
...
| `content-audit-backlog-burn.md` | working note, superseded (built on Linear tracking, retired 2026-09-05 by ST-117) | 2026-07-23 | Archive locally |
| `governance-layer-unwind-plan.md` | working note, superseded (the unwind it planned shipped as SUG-284, 2026-08-15) | 2026-08-13 | Archive locally |
| `HANDOFF-sug-268-phase-2.md` | handoff package, superseded (SUG-268 cancelled by SUG-284) | 2026-08-06 | Archive locally |
| `RESTART-2026-07-30.md` | working note, stale session handoff | 2026-07-30 | Archive locally |
...
| `workflow-audit-v0.3-grounded.md` | working note / audit, historical, predates several since-shipped process changes | 2026-07-24 | Archive locally |
| `SUG-196/README.md`, `SUG-196/failure-modes.md`, `SUG-196/methodology.md`, `SUG-196/skills-index.md` | working note — a stray, stale mirror of `docs/ai/agentic-caucus/` (diffed: both `methodology.md` and `failure-modes.md` differ from the live copies) | 2026-06-24 | Archive locally — superseded by the real `docs/ai/agentic-caucus/` |
...
|---|---|---|
| `Component rework _ explore_ decide_ handoff/README.md` | Backroads case-study component rework, locked 2026-05-04 | Archive locally — already implemented (live at `/case-studies/charting-a-new-course-for-backroads-com`) |
| `Component rework _ explore_ decide_ handoff/SUG-XX-decisions.md` | same package | Archive locally |
| `Component rework _ explore_ decide_ handoff/predecessor/SUG-88-decisions.md` | predecessor decision doc (MetadataCard + chip system), also locked and shipped | Archive locally |
| `handoff_platform_audit/README.md`, `AUDIT.md`, `CHANGES.md` | platform stats page audit handoff | Archive locally |
| `Project_Section_extracted/handoff_platform_audit/README.md`, `AUDIT.md`, `CHANGES.md` | **exact duplicate of `handoff_platform_audit/` above** | Archive locally |
| `design_handoff_governance_tweaks_1/README.md`, `CHANGES.md` | governance tweaks round 1 | Archive locally |
| `design_handoff_governance_tweaks_2/README.md`, `CHANGES.md` | round 2 — **overlaps round 1 and round 3** | Archive locally |
| `design_handoff_governance_tweaks_3/README.md`, `CHANGES.md`, `ADDENDUM-prior-work.md`, `ADDENDUM-prior-work-changes.md` | round 3, most current of the three | Archive locally (or keep this one only, if the tweaks shipped and a record is wanted) |
| `platform-stats-page-ii/README.md` + nested `project/design_handoff_governance_tweaks/README.md`, `CHANGES.md`, `ADDENDUM-prior-work.md`, `ADDENDUM-prior-work-changes.md` | **another copy of the governance-tweaks package**, nested inside a "page ii" folder | Archive locally |
| `platform-stats-page-ii/project/uploads/SUG-119-table-audit-converge-st-table.md` | a design-tool upload artifact — a copy of the SUG-119 table-audit epic doc, which already shipped and is archived at `docs/shipped/zArchive/2026/SUG-119-table-audit-converge-st-table.md` | Archive locally — superseded, already shipped |
| `design_handoff_PageHeader/README.md`, `COMPONENT_README.md` | PageHeader component handoff | Archive locally |
| `design_handoff_TermDetail/README.md` | glossary term-detail handoff | Archive locally |
| `design_handoff_content_list/README.md` | content-list view handoff | Archive locally |
| `design_handoff_iconbutton_form-inputs/README.md` | icon button / form inputs handoff | Archive locally |
| `design_handoff_ledger_button_update/README.md` | Ledger button update handoff | Archive locally |
| `design_handoff_site_graph/README.md`, `SUG-105-phase-2-handoff-notes.md`, `SUG-81-site-wide-knowledge-graph.md` | knowledge-graph site-graph handoff, Phase 2 notes | Archive locally |
| `design_handoff_site_graph_2/README.md`, `SUG-81-site-wide-knowledge-graph.md` | **duplicate of `design_handoff_site_graph/`** | Archive locally |
| `knowledge-graph-claude-design-2/README.md` + 3 nested copies of `design_handoff_site_graph/README.md` and `SUG-81-site-wide-knowledge-graph.md` (in `project/`, `project/design_handoff_site_graph/`, `project/uploads/`) | **a Claude Design export bundling yet another copy of the same site-graph handoff**, three times over, plus image uploads | Archive locally |
| `design_handoff_storybook_docs_template/README.md`, `SECTION-RULES.md` | Storybook docs template handoff | Archive locally |
| `ledger-listviews/README.md`, `ledger-listviews/project/handoff.md` | Ledger listviews handoff | Archive locally |
...
- [x] This report is committed under `docs/reviews/`; `docs/drafts/` itself is untouched — confirmed via `git status` before and after
...
Everything else marked "archive locally" is a session-cannot-delete judgment call by design — this audit lists them, it doesn't remove them.
