---
**Epic:** SUG-TBD — Consolidate StatGrid + StatTileSection into Grid primitive
**Linear Issue:** [SUG-TBD](https://linear.app/sugartown/issue/SUG-TBD)
**Status:** Backlog
**Priority:** 🟢 Next
**Merge strategy:** (b) Single close-out — one long-lived branch, one mini-release at the end
---

# SUG-TBD — Consolidate StatGrid + StatTileSection into Grid primitive
...
- **Linear:** [SUG-TBD](https://linear.app/sugartown/issue/SUG-TBD)
