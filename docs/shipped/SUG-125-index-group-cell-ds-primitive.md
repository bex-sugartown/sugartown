...
- `IndexCell.stories.jsx` — all 4 states, as button + as anchor — category: `Components`
- `IndexGroup.stories.jsx` — full 27-letter strip, partial strip, single-column variant — category: `Components`
