...
// ── AI-Generated Footer ───────────────────────────────────────────────────────
// Add at the bottom of every guidelines doc page.

export function AiGeneratedFooter() {
  return (
    <footer style={{
      marginTop: '4rem',
      paddingTop: '1.25rem',
      borderTop: '1px solid var(--st-color-border-default)',
      fontFamily: 'var(--st-font-family-mono)',
      fontSize: '0.7rem',
      ...
      <span>These guidelines were generated by Claude (Anthropic AI).</span>
      <a
        href="https://sugartown.io/ai-ethics"
        target="_blank"
        rel="noopener noreferrer"
        style={{ color: 'inherit', textDecoration: 'underline', textUnderlineOffset: '2px' }}
      >
        Sugartown AI ethics policy
      </a>
    </footer>
  );
}
